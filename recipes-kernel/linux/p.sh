...
git diff --no-index ~/EL/poky/meta-mylayer/recipes-kernel/linux/sun8i-h2-plus-orangepi-zero_orig.dts arch/arm/boot/dts/sun8i-h2-plus-orangepi-zero.dts > ~/EL/poky/meta-mylayer/recipes-kernel/linux/panel_st7789v_DT.patch
